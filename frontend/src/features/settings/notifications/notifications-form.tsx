              ...
              render={({ field }) => (
                <FormItem className='flex flex-row items-center justify-between rounded-lg border p-4'>
                  <div className='space-y-0.5'>
                    ...
                    <FormDescription>
                      Recibe correos sobre nuevos productos, características y más.
                    </FormDescription>
                  </div>
                  <FormControl>
                    <Switch
              ...
              render={({ field }) => (
                <FormItem className='flex flex-row items-center justify-between rounded-lg border p-4'>
                  <div className='space-y-0.5'>
                    ...
                    <FormDescription>
                      Recibe correos de solicitudes de amistad, seguimientos y más.
                    </FormDescription>
                  </div>
                  <FormControl>
                    <Switch
          ...
          render={({ field }) => (
            <FormItem className='relative flex flex-row items-start'>
              ...
              <div className='space-y-1 leading-none'>
                <FormLabel>
                  Usar diferentes configuraciones para mis dispositivos móviles
                </FormLabel>
                <FormDescription>
